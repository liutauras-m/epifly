...
<style>
  ...
  .toast-success { border-left-color: var(--success, #16a34a); }
  .toast-error   { border-left-color: var(--danger, #dc2626); }
  .toast-warning { border-left-color: #d97706; }
  .toast-msg { flex: 1; }
  .toast-close {
    background: none; border: none; padding: 0;
    cursor: pointer; opacity: 0.5; flex-shrink: 0; margin-top: 1px;
  }
